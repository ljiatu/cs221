...
class CNN(Module):
    def __init__(self, d_in: int, d_out: int):
        ...
        self.filter_1word = Conv2d(1, 1, (1, 1))
        self.filter_2words = Conv2d(1, 1, (2, 1))
        self.filter_5words = Conv2d(1, 1, (5, 1))

        # 3 pooling layers. 1 for each filter above.
        # The result for each max pool is a 1 x 100 vector.
        self.pool_1word = MaxPool2d((50, 1))
        self.pool_2words = MaxPool2d((49, 1))
        self.pool_5words = MaxPool2d((46, 1))

        self.fc_layer = Linear(300, HIDDEN_LAYER_DIMENSION)
